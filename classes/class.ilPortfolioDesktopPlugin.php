...
/**
 * ilPortfolioDesktopPlugin
 *
 * @author  Fabian Schmid <fs@studer-raimann.ch>
 * @version 0.0.1
 *
 */
class ilPortfolioDesktopPlugin extends ilUserInterfaceHookPlugin {

	const PN = 'PortfolioDesktop';
	/**
	 * @var ilPortfolioDesktopPlugin
	 */
	...
	/**
	 * @return ilPortfolioDesktopPlugin
	 */
